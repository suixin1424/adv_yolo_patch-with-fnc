...
class fnc(nn.Module):
    ...
    def forward(self, features):
        ...
        feature_norm_ = feature_norm.mean(dim=(2, 3), keepdim=True)
        g = torch.min(feature_norm, a*feature_norm_) / feature_norm
        # Multiply g with features to get the output
        out = g * features
        return out
...
class Darknet(nn.Module):
    ...
    def load_weights(self, weightfile):
        fp = open("/home/zhuyiming/ssd2/zhuyiming/yolov2-patch/adversarial-yolo/weights/yolo.weights", 'rb')
